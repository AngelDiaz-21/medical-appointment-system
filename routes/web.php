...
Route::middleware(['auth', 'admin'])->group(function () {
    ...
    Route::get('/specialties', [SpecialtyController::class, 'index']); // Esta ruta va devolver una vista de las especialidades

    // Esta ruta nos va a devolver un formulario para registrar nuevas especialidades
    Route::get('/specialties/create', [SpecialtyController::class, 'create']); // Vamos a ver el formulario de registro. Esta peticion la hacemos al visitar la pagina de registro
    ...
    Route::post('/specialties', [SpecialtyController::class, 'store']); //Esta peticion se lleva a cabo cuando se envia el form de registro (operacion insert en BD)
