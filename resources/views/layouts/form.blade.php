				...
				<div class="header-body text-center mb-7">
					<div class="row justify-content-center">
						<div class="col-lg-5 col-md-6">
							<h1 class="text-white">
								<!-- Y le damos un valor por defecto en caso de que no se definiera esta seccion de forma especifica en las vistas hijas -->
			...
			<div class="row align-items-center justify-content-xl-between">
				<div class="col-xl-6">
					<div class="copyright text-center text-xl-left text-muted">
						<!--Esta variable "app.name" representa el nombre de nuestra aplicacion, si queremos mostrar el nombre de nuestra aplicacion en varias secciones de la pagina es recomendable usar esta expresion -->
